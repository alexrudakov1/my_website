...
knitr::include_graphics("yield_curve_parable.jpg", error = FALSE)
```
...
knitr::include_graphics("yield_curve_challenge.png", error = FALSE)
```
...
knitr::include_graphics("yield_curve1.png", error = FALSE)
```
...
knitr::include_graphics("yield_curve2.png", error = FALSE)
```
...
knitr::include_graphics("yield_curve3.png", error = FALSE)
```
